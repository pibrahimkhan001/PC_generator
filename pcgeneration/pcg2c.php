...
if(!empty($_GET['sthtno'])){

  $_SESSION['pcg2']=rand(0,1000);

  $x=$_GET['sthtno'];
  $_GET['sthtno'] = strtoupper($_GET['sthtno']);
  require('pcgs.php');
  $cgs_obj = new PCGS();
  $r = $cgs_obj->checkHtno($_GET['sthtno']);

if($r){
  $t = $cgs_obj->checkDetails($_GET['sthtno']);
  if($t['status']==1)
  {
  ...
  $res = $cgs_obj->getStDetails($_GET['sthtno']);
        ...
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            <form class="form-horizontal" role="form" action="pcg3.php" method="post">
              ...
              <div class="form-group">
                       <label for="adrno" class="col-sm-6 control-label labelapply3">Adhar Number:</label>
                       <div class="col-sm-4">
                         <?php
                         if(!empty($res['adhar']) || $res['adhar']!="0"){
                           echo $res['adhar'];
                         }else {
                           echo "Not Provided";
                         }
             ...
             <div class="form-group">
                 <label for="adrno" class="col-sm-6 control-label labelapply3">Upload Image:</label>
                   <div class="col-sm-4">
                     <?php  if(!empty($res['image'])){
                        echo '<img src="'.$res['image'].'" height="120" width="100"/>';
                      }else {
                        echo "No Image Found";
                      }
                     ?>
              ...
              <div class="form-group">
                <label for="inputHtno" class="col-sm-6 control-label labelapply3">Father's Name:</label>
                <div class="col-sm-6">
                  <?php echo $res['fname']; ?>
                </div>
              </div>
              ...
              <div class="form-group">
                <label for="inputHtno" class="col-sm-6 control-label labelapply3">Mother's Name:</label>
                <div class="col-sm-6">
                  <?php echo $res['mname']; ?>
                </div>
              </div>
              ...
              <input type='hidden' name='pcg2' value='<?php echo $_SESSION['pcg2'];?>' />
                ...
                <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="" class="col-sm-6 control-label labelapply3">Month & Year of Examinations Passed:</label>
                    <div class="col-sm-2">
                  ...
                  <div class="form-group">
                    ...
                    <input type='hidden' name='aadhar' value='<?php echo $res['adhar']?>' />
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6" align='center'>
                  <a href="pcg22.php?id=<?php echo $res['htno']; ?>" class="btn btn-default">&nbsp;&nbsp;Edit Student Details&nbsp;&nbsp;</a>
                </div>
