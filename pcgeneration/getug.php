              ...
              <div class="col-xs-12 col-sm-9">
                ...
                <div class="panel panel-info">
                  <div class="panel-heading">
                    <h4>Generate Report from Specified Date</h4>
                  </div>
                  <div class="panel-body">
                    <br>
                    <form class="form-horizontal" role="form" action="conformgetug.php" method="post">
                      <div class="form-group">
                        <label for="inputTrans" class="col-sm-5 control-label">Select Date (dd-mm-yyyy):</label>
					  ...
					  <div class="form-group">
                        <div class="col-sm-offset-6 col-sm-6">
                          <button type="submit" class="btn btn-default">Download Excel</button>
                        </div>
                      </div>
